...
async def test_create_seller(async_client):
    data = {"first_name": "Nastya", "last_name": "Vredina", "email": "Nastya@gmail.com", "password": "16748"}
    ...
    assert result_data["first_name"] == "Nastya"
    assert result_data["last_name"] == "Vredina"
    assert result_data["email"] == "Nastya@gmail.com"
